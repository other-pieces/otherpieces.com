...
import { spaceDouble, spaceStackDouble } from '../../theme/settings';
...
const ContactForm = () => (
  <Form name="contact" action="/thank-you">
    <StyledFormLayout>
      ...
      <StyledMessageTextarea label="Message" name="message" placeholder="Give us the deets" />
    </StyledFormLayout>
    <ButtonDefault type="submit">Send it</ButtonDefault>
  </Form>
);
