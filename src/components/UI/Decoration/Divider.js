...
import { colorPeacock048, spaceStackCenterOct, spaceStackCenterQuad } from '../../../theme/settings';

const Divider = () => (
  <StyledDivider viewBox="0 0 910 75" fill="none" xmlns="http://www.w3.org/2000/svg" role="presentation">
    <path
